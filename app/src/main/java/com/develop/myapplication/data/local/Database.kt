...
@Database(entities = [HospitalEntity::class, Horario_horasEntity::class, UsuarioEntity::class, PacienteEntity::class, MedicoEntity::class, CitaEntity::class], version = 1, exportSchema = false)
